...
export default function DropDownField({
  ...
  return (
    <div className='flex flex-col w-full'>
      ...
      <select className='mt-2 w-full bg-secondary border-2 border-text  text-text text-base py-3 px-2 pr-8 rounded-lg leading-tight focus:outline-none appearance-none'>
